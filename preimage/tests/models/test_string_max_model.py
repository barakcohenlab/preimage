...
class TestStringMaximizationModel(unittest2.TestCase):
    ...
    def test_model_predict_returns_expected_y_and_bound(self):
        ...
        np.testing.assert_array_equal(Y, self.Y_test_length_one)
        np.testing.assert_array_equal(bound, self.bound_length_one)
    ...
    def test_two_solutions_model_predict_returns_expected_y_and_bounds(self):
        ...
        np.testing.assert_array_equal(Y, self.Y_test_length_two)
        np.testing.assert_array_equal(bound, self.bounds_length_two)
