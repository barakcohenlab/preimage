...
class TestMaxBoundCalculator(unittest2.TestCase):
    ...
    def setup_graph(self):
        self.graph_one_gram = np.array([[0, 2, 1], [3, 2, 2.], [3, 3, 4]], dtype=np.float64)
        self.graph_one_gram_1d_weight = np.array([[0, 2, 1], [2, 4, 3.]], dtype=np.float64)
        self.graph_two_gram = np.array([np.arange(0, 9), [6, 7, 9, 10, 11, 12, 14, 15, 16]], dtype=np.float64)

    def setup_weights(self):
        self.weights_one_gram_1d = np.array([[0, 2, 1]], dtype=np.float64)
        self.weights_one_gram = np.array([[0, 2, 1], [1, 0, 0], [0, 0, 1]], dtype=np.float64)
        self.weights_two_gram = np.array(np.arange(0, 9).reshape(1, -1), dtype=np.float64)
    ...
    def test_one_gram_length_one_start_node_real_values_is_first_graph_weights_partition(self):
        ...
        np.testing.assert_array_almost_equal(real_values, self.weights_one_gram[0, :])
    ...
    def test_one_gram_length_one_start_nodes_bound_values_is_first_graph_partition(self):
        ...
        np.testing.assert_array_almost_equal(bound_values, self.graph_one_gram[0, :])
    ...
    def test_one_gram_length_two_start_node_real_values_is_second_graph_weights_partition(self):
        ...
        np.testing.assert_array_almost_equal(real_values, self.weights_one_gram[1, :])
    ...
    def test_one_gram_length_two_start_node_bound_values_is_second_graph_weights_partition(self):
        ...
        np.testing.assert_array_almost_equal(bound_values, self.graph_one_gram[1, :])
    ...
    def test_one_gram_length_two_1d_weights_start_node_real_values_is_first_graph_weights_partition(self):
        ...
        np.testing.assert_array_almost_equal(real_values, self.weights_one_gram_1d[0, :])
    ...
    def test_two_gram_length_two_start_node_real_values_is_first_graph_weights_partition(self):
        ...
        np.testing.assert_array_almost_equal(real_values, self.weights_two_gram[0, :])
    ...
    def test_two_gram_length_three_start_node_bound_values_is_second_graph_partition(self):
        ...
        np.testing.assert_array_almost_equal(real_values, self.graph_two_gram[1, :])
...
class TestOCRMinBoundCalculator(unittest2.TestCase):
    ...
    def setup_position_weights(self):
        self.position_weights_large_sigma = np.array([1, 1, 1], dtype=np.float64)
        self.position_weights_medium_sigma = np.array([1, 0.5, 0], dtype=np.float64)
        self.position_weights_small_sigma = np.array([1, 0, 0], dtype=np.float64)
    ...
    def test_one_gram_length_one_start_node_real_values_is_one(self):
        ...
        np.testing.assert_array_almost_equal(real_values, np.ones(len(self.one_grams)))
    ...
    def test_one_gram_length_one_start_nodes_bound_values_is_one(self):
        ...
        np.testing.assert_array_almost_equal(bound_values, np.ones(len(self.one_grams)))
    ...
    def test_one_gram_length_two_start_node_bound_values_is_two(self):
        ...
        np.testing.assert_array_almost_equal(bound_values, 2 * np.ones(len(self.one_grams)))
    ...
    def test_two_gram_length_one_start_node_bound_values_is_one(self):
        ...
        np.testing.assert_array_almost_equal(bound_values, np.ones(len(self.two_grams)))
...
class TestPeptideMinBoundCalculator(unittest2.TestCase):
    ...
    def setup_position_and_similarity_matrix(self):
        self.similarity_matrix_one_gram = np.array([[1, 0.5, 0.1], [0.5, 1, 0.2], [0.1, 0.2, 1]],
                                                      dtype=np.float64)
        self.similarity_matrix_two_gram = np.array([[1, 0.5], [0.5, 1]], dtype=np.float64)
        self.position_matrix_small_sigma = np.eye(5, dtype=np.float64)
        self.position_matrix_large_sigma = np.ones((5, 5), dtype=np.float64)
    ...
    def setup_bounds(self):
        self.one_gram_real_values = np.array([1., 1., 1.])
        self.two_gram_real_values = np.array([3., 3., 3., 3.])
        self.two_gram_large_sigma_p_real_values = np.array([5., 4., 4., 5.])
    ...
    def test_one_gram_length_one_start_node_real_values_returns_expected_values(self):
        ...
        np.testing.assert_array_almost_equal(real_values, self.one_gram_real_values)
    ...
    def test_two_gram_length_three_start_node_real_values_returns_expected_values(self):
        ...
        np.testing.assert_array_almost_equal(real_values, self.two_gram_real_values)
    ...
    def test_one_gram_length_three_large_sigma_p_start_node_bound_values_returns_expected_value(self):
        ...
        np.testing.assert_array_almost_equal(bound_values, self.start_bounds_one_gram_large_sigma_length_three)
    ...
    def test_two_gram_length_three_small_sigma_p_start_node_bound_values_returns_expected_value(self):
        ...
        np.testing.assert_array_almost_equal(bound_values, self.two_gram_real_values + 2)
    ...
    def test_two_gram_length_three_large_sigma_p_start_node_bound_values_returns_expected_value(self):
        ...
        np.testing.assert_array_almost_equal(bound_values, self.start_bounds_two_gram_large_sigma_length_three)
